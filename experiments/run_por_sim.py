"""
Module: experiments.run_por_sim
================================
Description:
    ...
    Or via the full experiment suite::
...
def client_fn(context) -> fl.client.Client:
    ...
    if cid_int >= (NUM_CLIENTS - NUM_FALSE_NODES):
        ...
        return FalseNode(cid, train_loader, test_loader, DEVICE, feature_names=feature_names, num_classes=NUM_CLASSES, target_label=t_label).to_client()
    else:
