"""
visualizations/g19_consensus_jaccard_rounds
=========================================
G19 (Blueprint G9): Consensus Graph Jaccard vs. ASIA Ground Truth — per round.
Uses: saved_models/asia/consensus_round_N.gpickle (generated during simulation)
...
def main():
    ...
    if has_per_round:
        ...
        print("      Re-simulate with: python experiments/run_por_sim.py")
    ...
    if has_per_round:
        ...
        ax1.text(0.5, 0.5,
                 ...
                 'Re-run experiments/run_por_sim.py to generate per-round consensus files.',
