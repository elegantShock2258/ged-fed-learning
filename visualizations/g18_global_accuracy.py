"""
visualizations/g18_global_accuracy
================================
...
def main():
    ...
    if eval_res:
        ...
        ax1.text(0.02, 0.98,
                 '⚠  Estimated values — run experiments/eval_metrics.py for exact results',
    ...
    note(ax2, 'MTA logged at final round via experiments/eval_metrics.py')
