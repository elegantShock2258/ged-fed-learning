...
def main():
    ...
    # perfect classifier corner
    ax.scatter(0, 1, s=100, color=C['accept'], zorder=5,
               marker='*', label='Perfect classifier')
    ...
    ax.text(0.02, 0.97, info_text, transform=ax.transAxes,
            fontsize=9, va='top', color=C['subtext'],
