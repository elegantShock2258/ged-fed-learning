...
Usage: python graphs/run_all.py
All PNGs are saved to the graphs/ directory.
"""
import subprocess
import sys
import time
...
SCRIPTS = [
    ...
    # G18/G20 will auto-run eval_asr_mta.py if eval_results.json is missing.
...
DATA_STATUS = {
    ...
    "saved_models/asia/eval_results.json":
        "⚠ MTA/ASR eval (run: python graphs/eval_asr_mta.py)",
}
...
def main():
    ...
    # list generated PNGs
    pngs = sorted(GRAPHS_DIR.glob("G*.png"))
